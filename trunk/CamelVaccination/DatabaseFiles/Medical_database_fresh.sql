...
INSERT INTO `medici` VALUES (1,'zambraga_1','zamby','Piero','Zambraga'),(2,'genovesi_2','genovesi','Libera Maria','Genovesi'),(3,'angelo_3','angelo','Lodovico','Angelo'),(4,'toscano_4','toscano','Eleuterio','Toscano'),(5,'udinesi_5','udinesi','Violanda','Udinesi');
...
CREATE TABLE `vaccinazioni` (
  ...
  `dataVaccinazione` datetime NOT NULL,
  PRIMARY KEY (`idPaziente`,`dataVaccinazione`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vaccinazioni`
--

LOCK TABLES `vaccinazioni` WRITE;
/*!40000 ALTER TABLE `vaccinazioni` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaccinazioni` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2011-11-09 18:52:13
